...
public class SimpleAddressTest {
    ...
    public void testInvalidAddress(){
        ...
        try {
            // FIXME: to check the assumption that an address that contains only numbers is invalid
    ...
    public void testSimpleAddressWithSpace(){
        assertArrayEquals(parser.parseAddress("Am Bachle 23"), new String[]{"Am Bachle", "23"});
    }
